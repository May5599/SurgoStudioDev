...
export default function AboutPage() {
  const founders = [
    {
      name: "Daniyal Zafar",
      role: "Co-Founder",
      img: "https://res.cloudinary.com/dvqibrc9d/image/upload/v1756999295/dan_sewr7r.jpg",
      quote:
        "Daniyal is one of the founding partners of Surgo Studios, shaping its creative vision and driving its growth across Canada and beyond.",
    },
    {
      name: "Sashien Godakandae",
      role: "Co-Founder",
      img: "https://res.cloudinary.com/dvqibrc9d/image/upload/v1756999295/sash_lzjsw2.jpg",
      quote:
        "As a co-founder of Surgo Studios, Sashien brings leadership, strategy, and a commitment to building lasting relationships with clients and partners.",
    },
    {
      name: "Surgo Leadership",
      role: "Executive Partner",
      img: "https://res.cloudinary.com/dvqibrc9d/image/upload/v1756999295/ceo_ac2x2g.jpg",
      quote:
        "Surgo Studios is built on trust, creativity, and collaboration. Our founding partners lead with a shared vision of amplifying stories that matter.",
    },
  ];
  ...
  <p className="max-w-4xl mx-auto text-center text-xl text-gray-600 mb-20 relative z-10">
    Surgo Studios is a Canadian video production company based in{" "}
    <strong>Ottawa</strong> and <strong>Toronto</strong>, trusted by
    brands across <strong>Ontario</strong>, <strong>Montreal</strong>, and
    nationwide. We create cinematic stories that inspire trust and
    captivate audiences across Canada.
  </p>
</section>
...
<section className="px-8 py-24 md:px-20">
  ...
  <div className="grid md:grid-cols-2 gap-12 items-center">
    <motion.img
      ...
      alt="Daniyal Zafar & Sashien Godakandae - Co-Founders of Surgo Studios"
    ...
    <div className="text-center md:text-left">
        ...
        <div className="grid sm:grid-cols-2 gap-12 mb-32">
          {leadership.map((p, i) => (
            ...
            >
              <img
                src={p.img}
                alt={`${p.name} - ${p.role} at Surgo Studios`}
      ...
      <section className="px-8 md:px-20">
        ...
        <p className="max-w-3xl mx-auto text-center text-lg text-gray-700 mb-20">
          From <strong>Ottawa</strong> to <strong>Toronto</strong>, from{" "}
          <strong>Montreal</strong> to Vancouver, Surgo Studios has partnered
          with Canadian businesses to deliver cinematic productions that
          resonate. Whether it’s a startup in Ontario or an established brand in
          Quebec, our team understands the cultural and creative pulse of
          Canada’s major cities — and we amplify it on screen.
        </p>
      </section>
          ...
          {["Technology", "Fashion", "Music", "E-commerce"].map((field, i) => (
            ...
            >
              ...
              <p className="text-sm text-gray-600 mt-2">
                ...
                with brands across Ottawa, Toronto, and Montreal.
              </p>
            </motion.div>
          ))}
        </div>
